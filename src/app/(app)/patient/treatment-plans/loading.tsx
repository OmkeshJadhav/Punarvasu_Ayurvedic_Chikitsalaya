...
import { PATIENT_TREATMENT_PLAN_COPY } from "@/features/treatment-plans/content";

/** A skeleton in the shape of the page, not the word "Loading". */
export default function PatientTreatmentPlansLoading() {
  return (
    <Section>
      <Container width="content">
        <SectionLoading label={PATIENT_TREATMENT_PLAN_COPY.heading}>
